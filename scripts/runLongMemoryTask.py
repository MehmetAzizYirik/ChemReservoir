...
class longMemoryTask:
    def __init__(self, seed, dg, tau, moleculeInflux, arguments, runTime=50, repetition=2):
        """
    ...
    def main(self):
        ...
        inflow = longMemoryTask.truncated_normal_distribution(self.moleculeInflux, len(input_graphs), sim.totalRunTime, repetition=self.repetition)
        ...
        error = cReg.runLongMemoryTask(stochData, tau=self.tau)
        return error
